...
function ProductListWithCat( { match}) {
  ...
  const [loading,setLoading]=useState(false)
    ...
    console.log("justche",match.params.id)
    ...
    const productInfo= async (e) => {
        ...
        const response=await axios.get(`http://localhost:8000/e-shop/category-product/${match.params.id}`,config)
...
export default ProductListWithCat
